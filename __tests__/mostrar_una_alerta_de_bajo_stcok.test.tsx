...
describe('Como empleado de una tienda de ropa (textil), me gustaría poder visualizar un menaje que me advierta del bajo stock, para poder recargar el producto.', () => {
